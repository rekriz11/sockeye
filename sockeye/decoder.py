...
class RecurrentDecoder(Decoder):
    ...
    def __init__(self,
        ...
        self.num_target_embed = self.config.num_embed
        ...
        self.embedding = encoder.Embedding(config.num_embed, config.vocab_size,
                                           prefix=C.TARGET_EMBEDDING_PREFIX, dropout=0.,
                                           embed_weight=embed_weight)  # TODO dropout?

        if config.weight_tying:
            check_condition(self.num_hidden == config.num_embed,
